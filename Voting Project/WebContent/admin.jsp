...
<div class="wrapper col1">
  <div id="header">
    <div id="logo">
      <h1><a href="#">AGC Technologies</a></h1>
    ...
    <div id="newsletter">
      ...
      <form action="login" method="post">
        <fieldset>
          ...
          <input type="text" name="id" onfocus="this.value=(this.value=='Name&hellip;')? '' : this.value ;"  />
          <input type="password" name="password" onfocus="this.value=(this.value=='Email&hellip;')? '' : this.value ;" />
...
<div class="wrapper col6">
  <div id="footer">
    <div id="login">
      <h2>Admin Login !</h2>
      <p>Admin can Login to his account here.</p>
      <form action="admin" method="post">
        <fieldset>
          <legend>Client Login</legend>
          <div class="fl_left">
            <input type="text" name="id" onfocus="this.value=(this.value=='Enter email address&hellip;')? '' : this.value ;" />
            <input type="password" name="password"  onfocus="this.value=(this.value=='Enter password&hellip;')? '' : this.value ;" />
          </div>
          <div class="fl_right">
